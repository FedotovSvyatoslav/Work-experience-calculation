...
from src.core.my_exceptions.my_exceptions import EmptyField, IntervalsIntersection, \
    IncorrectFormat, StartLatestThenEnd, EndAndEnteredDateBothEmpty

CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
RESOURCES_DIR = os.path.join(CURRENT_DIR, "..", "..", "resources")

UI_FILENAME = os.path.join(RESOURCES_DIR, "worker_info_dialog3.ui")
CALENDAR_ICON_FILENAME = os.path.join(RESOURCES_DIR, "calendar_icon.png")
